    ...
    public partial class Clientes : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            if (objcliente.IDCliente == 0)
            {
                ...
                if (idgenerado != 0)
                {
                    dgvdata.Rows.Add(new object[] {"",idgenerado, txtdocumento.Text,txtnombrecompleto.Text,
        ...
        private void btneliminar_Click(object sender, EventArgs e)
        {
            if (Convert.ToInt32(txtid.Text) != 0)
            {
                if (MessageBox.Show("¿Está seguro de eliminar el cliente?", "Mensaje", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    {
                        MessageBox.Show(Mensaje, "Error al eliminar el cliente", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    }
